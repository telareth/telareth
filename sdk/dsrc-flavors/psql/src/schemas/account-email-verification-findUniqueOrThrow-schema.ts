...
export const AccountEmailVerificationFindUniqueOrThrowSchema: z.ZodType<Prisma.AccountEmailVerificationFindUniqueOrThrowArgs> = z.object({ select: AccountEmailVerificationSelectObjectSchema.optional(), include: AccountEmailVerificationIncludeObjectSchema.optional(), where: AccountEmailVerificationWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.AccountEmailVerificationFindUniqueOrThrowArgs>;

export const AccountEmailVerificationFindUniqueOrThrowSchemaZodSchema = z.object({ select: AccountEmailVerificationSelectObjectSchema.optional(), include: AccountEmailVerificationIncludeObjectSchema.optional(), where: AccountEmailVerificationWhereUniqueInputObjectSchema }).strict();