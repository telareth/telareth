...
export const AccountEmailFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AccountEmailSelect> = z.object({
...
export const AccountEmailFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    email: z.boolean().optional(),
...
export const AccountEmailFindFirstOrThrowSchema: z.ZodType<Prisma.AccountEmailFindFirstOrThrowArgs> = z.object({ select: AccountEmailFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AccountEmailIncludeObjectSchema.optional()), orderBy: z.union([AccountEmailOrderByWithRelationInputObjectSchema, AccountEmailOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountEmailWhereInputObjectSchema.optional(), cursor: AccountEmailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountEmailScalarFieldEnum, AccountEmailScalarFieldEnum.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AccountEmailFindFirstOrThrowArgs>;

export const AccountEmailFindFirstOrThrowSchemaZodSchema = z.object({ select: AccountEmailFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AccountEmailIncludeObjectSchema.optional()), orderBy: z.union([AccountEmailOrderByWithRelationInputObjectSchema, AccountEmailOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountEmailWhereInputObjectSchema.optional(), cursor: AccountEmailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountEmailScalarFieldEnum, AccountEmailScalarFieldEnum.array()]).optional() }).strict();