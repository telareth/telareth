...
export const AccountPasswordFindFirstSelectSchema: z.ZodType<Prisma.AccountPasswordSelect> = z.object({
...
export const AccountPasswordFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    password: z.boolean().optional(),
...
export const AccountPasswordFindFirstSchema: z.ZodType<Prisma.AccountPasswordFindFirstArgs> = z.object({ select: AccountPasswordFindFirstSelectSchema.optional(), include: z.lazy(() => AccountPasswordIncludeObjectSchema.optional()), orderBy: z.union([AccountPasswordOrderByWithRelationInputObjectSchema, AccountPasswordOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountPasswordWhereInputObjectSchema.optional(), cursor: AccountPasswordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountPasswordScalarFieldEnum, AccountPasswordScalarFieldEnum.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AccountPasswordFindFirstArgs>;

export const AccountPasswordFindFirstSchemaZodSchema = z.object({ select: AccountPasswordFindFirstSelectSchema.optional(), include: z.lazy(() => AccountPasswordIncludeObjectSchema.optional()), orderBy: z.union([AccountPasswordOrderByWithRelationInputObjectSchema, AccountPasswordOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountPasswordWhereInputObjectSchema.optional(), cursor: AccountPasswordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountPasswordScalarFieldEnum, AccountPasswordScalarFieldEnum.array()]).optional() }).strict();