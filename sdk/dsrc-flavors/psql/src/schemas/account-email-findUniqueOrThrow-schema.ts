...
export const AccountEmailFindUniqueOrThrowSchema: z.ZodType<Prisma.AccountEmailFindUniqueOrThrowArgs> = z.object({ select: AccountEmailSelectObjectSchema.optional(), include: AccountEmailIncludeObjectSchema.optional(), where: AccountEmailWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.AccountEmailFindUniqueOrThrowArgs>;

export const AccountEmailFindUniqueOrThrowSchemaZodSchema = z.object({ select: AccountEmailSelectObjectSchema.optional(), include: AccountEmailIncludeObjectSchema.optional(), where: AccountEmailWhereUniqueInputObjectSchema }).strict();