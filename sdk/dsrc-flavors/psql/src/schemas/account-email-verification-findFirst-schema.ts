...
export const AccountEmailVerificationFindFirstSelectSchema: z.ZodType<Prisma.AccountEmailVerificationSelect> = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    email: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.AccountEmailVerificationSelect>;

export const AccountEmailVerificationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    email: z.boolean().optional()
  }).strict();

export const AccountEmailVerificationFindFirstSchema: z.ZodType<Prisma.AccountEmailVerificationFindFirstArgs> = z.object({ select: AccountEmailVerificationFindFirstSelectSchema.optional(), include: z.lazy(() => AccountEmailVerificationIncludeObjectSchema.optional()), orderBy: z.union([AccountEmailVerificationOrderByWithRelationInputObjectSchema, AccountEmailVerificationOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountEmailVerificationWhereInputObjectSchema.optional(), cursor: AccountEmailVerificationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountEmailVerificationScalarFieldEnum, AccountEmailVerificationScalarFieldEnum.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AccountEmailVerificationFindFirstArgs>;

export const AccountEmailVerificationFindFirstSchemaZodSchema = z.object({ select: AccountEmailVerificationFindFirstSelectSchema.optional(), include: z.lazy(() => AccountEmailVerificationIncludeObjectSchema.optional()), orderBy: z.union([AccountEmailVerificationOrderByWithRelationInputObjectSchema, AccountEmailVerificationOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountEmailVerificationWhereInputObjectSchema.optional(), cursor: AccountEmailVerificationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountEmailVerificationScalarFieldEnum, AccountEmailVerificationScalarFieldEnum.array()]).optional() }).strict();