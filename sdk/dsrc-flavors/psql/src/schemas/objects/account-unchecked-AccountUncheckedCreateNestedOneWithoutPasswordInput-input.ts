...
export const AccountUncheckedCreateNestedOneWithoutPasswordInputObjectSchema: z.ZodType<Prisma.AccountUncheckedCreateNestedOneWithoutPasswordInput> = makeSchema() as unknown as z.ZodType<Prisma.AccountUncheckedCreateNestedOneWithoutPasswordInput>;
export const AccountUncheckedCreateNestedOneWithoutPasswordInputObjectZodSchema = makeSchema();
