...
import { AccountEmailUpdateManyWithoutAccountNestedInputObjectSchema as AccountEmailUpdateManyWithoutAccountNestedInputObjectSchema } from './account-email-AccountEmailUpdateManyWithoutAccountNestedInput-input.js';
import { AccountPasswordUpdateOneRequiredWithoutAccountNestedInputObjectSchema as AccountPasswordUpdateOneRequiredWithoutAccountNestedInputObjectSchema } from './account-password-AccountPasswordUpdateOneRequiredWithoutAccountNestedInput-input.js'
...
const makeSchema = () => z.object({
  ...
  emails: z.lazy(() => AccountEmailUpdateManyWithoutAccountNestedInputObjectSchema).optional(),
  password: z.lazy(() => AccountPasswordUpdateOneRequiredWithoutAccountNestedInputObjectSchema).optional()
}).strict();
