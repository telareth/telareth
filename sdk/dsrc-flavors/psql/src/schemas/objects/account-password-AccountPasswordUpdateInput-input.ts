...
import { AccountUpdateOneWithoutPasswordNestedInputObjectSchema as AccountUpdateOneWithoutPasswordNestedInputObjectSchema } from './account-update-one-without-password-nested-input-AccountUpdateOneWithoutPasswordNestedInput-input.js'
...
const makeSchema = () => z.object({
  ...
  account: z.lazy(() => AccountUpdateOneWithoutPasswordNestedInputObjectSchema).optional()
}).strict();
export const AccountPasswordUpdateInputObjectSchema: z.ZodType<Prisma.AccountPasswordUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.AccountPasswordUpdateInput>;
export const AccountPasswordUpdateInputObjectZodSchema = makeSchema();
