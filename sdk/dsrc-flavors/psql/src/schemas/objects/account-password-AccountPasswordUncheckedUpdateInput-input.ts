...
import { AccountUncheckedUpdateOneWithoutPasswordNestedInputObjectSchema as AccountUncheckedUpdateOneWithoutPasswordNestedInputObjectSchema } from './account-unchecked-update-one-without-password-nested-input-AccountUncheckedUpdateOneWithoutPasswordNestedInput-input.js'
...
const makeSchema = () => z.object({
  ...
  account: z.lazy(() => AccountUncheckedUpdateOneWithoutPasswordNestedInputObjectSchema).optional()
}).strict();
export const AccountPasswordUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.AccountPasswordUncheckedUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.AccountPasswordUncheckedUpdateInput>;
export const AccountPasswordUncheckedUpdateInputObjectZodSchema = makeSchema();
