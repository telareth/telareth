...
export const AccountPasswordFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AccountPasswordSelect> = z.object({
...
export const AccountPasswordFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    password: z.boolean().optional(),
...
export const AccountPasswordFindFirstOrThrowSchema: z.ZodType<Prisma.AccountPasswordFindFirstOrThrowArgs> = z.object({ select: AccountPasswordFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AccountPasswordIncludeObjectSchema.optional()), orderBy: z.union([AccountPasswordOrderByWithRelationInputObjectSchema, AccountPasswordOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountPasswordWhereInputObjectSchema.optional(), cursor: AccountPasswordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountPasswordScalarFieldEnum, AccountPasswordScalarFieldEnum.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AccountPasswordFindFirstOrThrowArgs>;

export const AccountPasswordFindFirstOrThrowSchemaZodSchema = z.object({ select: AccountPasswordFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AccountPasswordIncludeObjectSchema.optional()), orderBy: z.union([AccountPasswordOrderByWithRelationInputObjectSchema, AccountPasswordOrderByWithRelationInputObjectSchema.array()]).optional(), where: AccountPasswordWhereInputObjectSchema.optional(), cursor: AccountPasswordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AccountPasswordScalarFieldEnum, AccountPasswordScalarFieldEnum.array()]).optional() }).strict();